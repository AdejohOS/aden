...
const mandates = [
    {
        ...
        description: 'ADEN will work on promoting online learning platforms that are accessible to students in different parts of Africa. The platforms should be user-friendly and accessible on low-bandwidth networks.',
    },
    {
        id: 2,
        title: 'Provide digital devices and infrastructure ',
        description: 'ADEN will aim to collaborate with governments, NGOs, and private organizations to provide digital devices and infrastructure to institutions and students in underserved areas.',
    },
    {
        id: 3,
        title: 'Develop digital educational resources.',
        description: 'ADEN would work on developing and promoting digital educational resources, such as e-books, videos, and interactive learning tools that can be used by students and teachers across Africa.',
    },
    {
        id: 4,
        title: 'Train teachers and educators.',
        description: 'ADEN could conduct training programs for lecturers and educators on how to use digital tools and resources in the classroom effectively.',
    },
    {
        id: 5,
        title: 'Conduct research on digital education.',
        description: 'ADEN will conduct research on the effectiveness of digital education in Africa and share the findings with policymakers, educators, and other stakeholders.',
    },
    {
        id: 6,
        title: 'Foster collaboration and partnerships ',
        description: 'ADEN will work on building collaborations and partnerships with governments, NGOs, and private organizations to improve digital education in Africa.',
    },
    {
        id: 7,
        title: 'Support innovation in digital education.',
        description: 'ADEN will support and promote innovative solutions in digital education, such as virtual laboratories, gamification, adaptive learning, and artificial intelligence.',
    },
    {
        id: 8,
        title: 'Strengthen feedback mechanisms.',
        description: 'ADEN will work to establish and strengthen feedback mechanisms to gather feedback from stakeholders (students and lecturers) that can help to continuously improve the quality and relevance of digital educational resources.',
    },
    {
        id: 9,
        title: 'Promote digital literacy.',
        description: ' ADEN would work on promoting digital literacy among students, lecturers, and parents in Africa to ensure that they are able to use digital tools and resources effectively.',
    },
]
