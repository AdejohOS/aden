    ...
    <div>
        ...
        <div className='container'>
          ...
          <div className='pt-20 pb-24 grid items-center grid-cols-1 md:grid-cols-2 gap-5'>
            <div className='p-4'>
              <h2 className='text-xl font-semibold text-green-500'>Send a message</h2>
                <p className='mb-4 text-slate-500'>You can always reachout to us.</p>
